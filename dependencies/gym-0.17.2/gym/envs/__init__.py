...
register(
    id='AntFullState-v2',
    entry_point='gym.envs.mujoco:AntFullStateEnv',
    max_episode_steps=1000,
    reward_threshold=6000.0,
)

register(
    id='HalfCheetahFullState-v2',
    entry_point='gym.envs.mujoco:HalfCheetahFullStateEnv',
    max_episode_steps=1000,
    reward_threshold=4800.0,
)

register(
    id='HopperFullState-v2',
    entry_point='gym.envs.mujoco:HopperFullStateEnv',
    max_episode_steps=1000,
    reward_threshold=3800.0,
)

register(
    id='Walker2dFullState-v2',
    entry_point='gym.envs.mujoco:Walker2dFullStateEnv',
    max_episode_steps=1000,
)
...
register(
    id='State-Swimmer-v2',
    entry_point='gym.envs.mujoco:StateSwimmerEnv',
    max_episode_steps=1000,
    reward_threshold=360.0,
)

register(
    id='State-Swimmer-pid-v2',
    entry_point='gym.envs.mujoco:StateSwimmerEnvPid',
    max_episode_steps=1000,
    reward_threshold=360.0,
)

register(
    id='State-Swimmer-AbsPos-v2',
    entry_point='gym.envs.mujoco:StateSwimmerPositionEnv',
    max_episode_steps=1000,
    reward_threshold=360.0,
)
...
register(
    id='State-Ant-v2',
    entry_point='gym.envs.mujoco:StateAntEnv',
    max_episode_steps=1000,
    reward_threshold=6000.0,
)
...
register(
    id='State-Ant-v3',
    entry_point='gym.envs.mujoco:StateAntEnv_v3',
    max_episode_steps=1000,
    reward_threshold=6000.0,
)
