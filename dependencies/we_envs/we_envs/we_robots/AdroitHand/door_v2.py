...
class DoorEnvV2(mujoco_env.MujocoEnv, utils.EzPickle):
    def __init__(self):
    ...
    def step(self, a):
        ...
        goal_achieved = True if np.linalg.norm(handle_pos - palm_pos) < 0.05 and abs(1.57-latch_pos) < 0.3 else False
        if goal_achieved:
            reward += 10.0
            reward_tb[3] = 10.0
