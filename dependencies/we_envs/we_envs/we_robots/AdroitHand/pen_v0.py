...
from we_envs.we_robots.AdroitHand.utils.quatmath import quat2euler, euler2quat
...
class PenEnvV0(mujoco_env.MujocoEnv, utils.EzPickle):
    def __init__(self):
        ...
        mujoco_env.MujocoEnv.__init__(self, curr_dir+'/../assets/mj_envs/DAPG_pen.xml', 5)
