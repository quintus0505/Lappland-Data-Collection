...
USAGE:\n
    ...
    $ python collect_primitives/auto_collect_relocate_primitive.py --option visualize *\n
    (choose from ['Approach', 'Grasp', 'Move2Target'])
'''
...
def relocate_visualize_primitive_demo(primitive_name, speed=1,):
